...
assert what_to_plot in ['main', 'asynch_supps', 'error_supp', 'predom_supp']
    ...
    ###################
        ...
        if what_to_plot == 'main':
            ...
            map_predom(ax, predom,
                       ...
                       covars=covars,
                       which_covars='top',
                       cbar_axlab='predominant covariate',
                      )
            ...
            fig_predom_supp.savefig('FIG_S16_predom_all_covars.png', dpi=500)
