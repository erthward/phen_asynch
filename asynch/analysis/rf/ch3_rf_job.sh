...
do
   ...
   do
      ...
      do
         Rscript --vanilla /global/home/users/drewhart/seasonality/seasonal_asynchrony/asynch/analysis/rf/phen_asynch_rf.r $var $neigh_rad $coords_as_covars > ch3_rf_${var}_${neigh_rad}_${coords_as_covars}.Rout 
      done
 done
done
