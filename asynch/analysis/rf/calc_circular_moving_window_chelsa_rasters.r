...
min_t_nsd <-focal(min_t, w=fw_min_t, fun=sd, na.rm=TRUE) 
writeRaster(min_t_nsd, '/global/scratch/users/drewhart/seasonality/CHELSA_bio6_1981-2010_V.2.1_5km_10CELLRAD_NEIGHSD.tif', 'GTiff', overwrite=T)

ppt_s_nsd <-focal(ppt_s, w=fw_min_t, fun=sd, na.rm=TRUE) 
writeRaster(ppt_s_nsd, '/global/scratch/users/drewhart/seasonality/CHELSA_bio15_1981-2010_V.2.1_5km_10CELLRAD_NEIGHSD.tif', 'GTiff', overwrite=T)
