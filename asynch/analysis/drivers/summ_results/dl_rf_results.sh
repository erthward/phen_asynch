scp drewhart@dtn.brc.berkeley.edu:/global/scratch/users/drewhart/seasonality/rf_data/rf_\*_importance_\* .

scp drewhart@dtn.brc.berkeley.edu:/global/scratch/users/drewhart/seasonality/rf_data/\*.Rout .
