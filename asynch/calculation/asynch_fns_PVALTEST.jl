...
if splitpath(pwd())[2] == "home"
    const BASE_DATA_DIR = "/media/deth/SLAB/diss/3-phn/GEE_outputs_asynch_pval_test/"
# ... or else get path on Savio
else
    const BASE_DATA_DIR = "/global/scratch/users/drewhart/seasonality/GEE_outputs_asynch_pval_test/"
end
