...
do
   ...
   do
      ...
      julia -p 32 /global/home/users/drewhart/seasonality/seasonal_asynchrony/src/asynch/calc/calc_asynch.jl --neigh_rad $neigh_rad --var $var > ch3_asynch_job_${var}_${neigh_rad}.jlout
