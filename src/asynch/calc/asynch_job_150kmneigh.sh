...
do
   ...
   do
      ...
      /global/home/groups/consultsw/sl-7.x86_64/modules/julia/1.4.1/bin/julia -p 32 /global/home/users/drewhart/seasonality/seasonal_asynchrony/asynch/src/calc/calc_asynch.jl --neigh_rad $neigh_rad --var $var > ch3_asynch_job_${var}_${neigh_rad}.jlout
