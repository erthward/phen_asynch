...
nirv_val = pd.read_csv('./FLUXNET_validation_results_NIRv.csv')
sif_val = pd.read_csv('./FLUXNET_validation_results_SIF.csv')
...
# print number of validation datasets for each RS dataset
...
# write out
val.to_csv('./TABLE_S1_FLUXNET_validation_all_results.csv',
           index=False,
          )
