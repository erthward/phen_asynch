...
# 1. choose a few cells across the DR transect (perhaps based on
# assessing how data rich each cell is), then plot the time series
# for those particular cells in a multi-line plot

# 2. figure out how to add universal colorbar to all plots
...
# toggle for whether or not to plot the map
plot_map = True
...
# set a bounding box within which to plot any data
# plt_x_bnds = (-180, 180)
# plt_y_bnds = (-90, 90)
