...
1. presents a simple method for near-global, consistent estimation of characteristic, annual land surface phenology <span style="color:gray;">(*plain English*: presents a technique to estimate, nearly everywhere, the shape of seasonal plant growth cycles in an average year)</span>
