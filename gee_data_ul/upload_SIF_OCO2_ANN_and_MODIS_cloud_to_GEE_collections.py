...
assert dataset in ['cloud', 'sif'], 'Valid datasets include: "cloud", "SIF".'
...
gc_bucket_dict = {'sif': "seasonality_data/OCO2_SIF_ANN",
                  'cloud': "seasonality_data/EarthEnv_MODIS_cloud"
                 }
gc_bucket = gc_bucket_dict[dataset]
print(gc_bucket)

img_coll_dict = {'sif': "users/drewhart/seasonality_data/OCO2_SIF_ANN",
                 'cloud':"users/drewhart/seasonality_data/EarthEnv_MODIS_cloud"}
...
data_dir_dict = {'sif': ("/run/media/drew/SLAB/seasonality/SIF/OCO-2/"
                 ...
                 'cloud': "/run/media/drew/SLAB/seasonality/other/cloud"
                }
...
df_file_dict = {'sif': 'SIF_OCO2_ANN_upload_metadata.csv',
                'cloud': 'MODIS_cloud_upload_metadata.csv'}
